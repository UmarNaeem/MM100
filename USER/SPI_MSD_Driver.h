...
#define _card_enable()      	GPIO_ResetBits(SD_CS_PORT,SD_CS_PIN)
#define _card_disable()     	GPIO_SetBits(SD_CS_PORT,SD_CS_PIN)
#define _card_power_on()
#define _card_insert()       	GPIO_ReadInputDataBit(SD_CD_PORT,SD_CD_PIN)
